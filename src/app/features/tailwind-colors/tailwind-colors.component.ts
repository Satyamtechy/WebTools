...
const TAILWIND_COLORS: TailwindColor[] = [
  ...
  { name: 'neutral', shades: { '50':'#fafafa','100':'#f5f5f5','200':'#e5e5e5','300':'#d4d4d4','400':'#a3a3a3','500':'#737373','600':'#525252','700':'#404040','800':'#262626','900':'#171717','950':'#0a0a0a' } },
  { name: 'stone', shades: { '50':'#fafaf9','100':'#f5f5f4','200':'#e7e5e4','300':'#d6d3d1','400':'#a8a29e','500':'#78716c','600':'#57534e','700':'#44403c','800':'#292524','900':'#1c1917','950':'#0c0a09' } },
  ...
  { name: 'lime', shades: { '50':'#f7fee7','100':'#ecfccb','200':'#d9f99d','300':'#bef264','400':'#a3e635','500':'#84cc16','600':'#65a30d','700':'#4d7c0f','800':'#3f6212','900':'#365314','950':'#1a2e05' } },
...
@Component({
  selector: 'app-tailwind-colors',
  standalone: true,
  imports: [FormsModule],
  templateUrl: './tailwind-colors.component.html',
  styleUrl: './tailwind-colors.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TailwindColorsComponent {
  ...
  readonly filteredColors = computed(() => {
    ...
    return q ? TAILWIND_COLORS.filter(c => c.name.includes(q)) : TAILWIND_COLORS;
  });
  ...
  getClass(name: string, shade: string): string {
    return `bg-${name}-${shade}`;
  }

  async copy(name: string, shade: string, hex: string): Promise<void> {
